...
class WysiwygInput<T> extends StatefulWidget {
  final Widget? labelSave;
  NotusDocument? Function(NotusDocument)? onSave;
  String hint;
  T? fractal;
  WysiwygInput({
    Key? key,
...
class _WysiwygInputState extends State<WysiwygInput>
  ...
  save() async {
    if (widget.onSave != null) {
      final doc = widget.onSave!(_controller.document);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: Container(
        ...
        child: Row(children: [
          ElevatedButton(
            child: widget.labelSave ?? const Icon(Icons.save),
            onPressed: () {
